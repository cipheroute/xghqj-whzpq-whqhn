...
Use a published version in production, for example `v1.0.1`:

```text
https://cdn.jsdelivr.net/gh/cipheroute/xghqj-whzpq-whqhn@v1.0.1/geosite-mini.dat
https://cdn.jsdelivr.net/gh/cipheroute/xghqj-whzpq-whqhn@v1.0.1/geoip-mini.dat
```
